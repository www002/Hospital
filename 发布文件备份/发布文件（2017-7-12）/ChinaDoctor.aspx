<%@ page language="C#" autoeventwireup="true" inherits="ChinaDoctor, App_Web_wbiuerbv" %>
    ...
    <div class="contentPagetslf">
        ...
        <div class="rightt">
            <div class="rightt_top">
                ...
                <div class="zi">
                    <asp:Label ID="tit" runat="server">中医特色</asp:Label></div>
                <div class="rg">
                    <img src="img/munbtn/neir_r1_c14.jpg" /></div>
            </div>
            <div class="segmentDetail">
                <div class="title">
                    <%Models.Drug hf = this.GetDrugById();%>
                    <%if (hf != null)
                      {%>
                    <h2>
                        <%=hf.DName.ToString()%></h2>
                    <h5>
