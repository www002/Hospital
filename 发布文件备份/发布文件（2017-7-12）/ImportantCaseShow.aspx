<%@ page language="C#" autoeventwireup="true" inherits="ImportantCaseShow, App_Web_wbiuerbv" %>
    ...
    <div class="contentPagetslf">
        ...
        <div class="rightt">
            <div class="rightt_top">
                ...
                <div class="zi">
                    <asp:Label ID="tit" runat="server">典型病例</asp:Label></div>
                <div class="rg">
                    <img src="img/munbtn/neir_r1_c14.jpg" /></div>
            </div>
            <div class="segmentDetail">
                <div class="title">
                    <%Models.ImportantCase news = this.GetImportantCaseById();%>
                    <%if (news != null)
                      {%>
                    <h2>
                        <%=news.ITitle.ToString()%></h2>
                    <h5>
