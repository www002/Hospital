<%@ page language="C#" autoeventwireup="true" inherits="Admin_H_NewEdit, App_Web_tgvvesi-" validaterequest="false" %>
    ...
    <div align="center">
        ...
        <table class="tab">
            <tr>
                ...
                <td class="tds">
                    <uc3:RadioControl ID="RadioControl1" runat="server" IsText="新闻" NoText="公告" IsUpdate="false" defaultChecked="1" />
                </td>
            </tr>
            <tr>
                <td class="tdName">
                ...
                <td class="tds">
                    <input type="text" id="txtSubHead" runat="server" class="txt" />
                </td>
                <td class="tdName">
                    是否启用：
                </td>
            ...
            <tr>
                <td colspan="12" align="center">
                    <asp:Button ID="btnIn" runat="server" Text="添加" OnClientClick="return New()" />
