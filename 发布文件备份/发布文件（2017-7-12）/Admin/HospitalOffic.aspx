<%@ page language="C#" autoeventwireup="true" inherits="Admin_HospitalOffic, App_Web_tgvvesi-" %>
    ...
    <div align="center">
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" EmptyDataRowStyle-HorizontalAlign="Center"
            ...
            <Columns>   
                ...
                <asp:BoundField HeaderText="科室名称" DataField="OName" />
                <asp:TemplateField HeaderText="科室照片" ItemStyle-Width="210px">
                    <ItemTemplate>
                        <asp:Image ID="img1" ImageUrl='<%#Eval("ImgURL") %>' runat="server" AlternateText="image lost" width="200px" height="120px"/>                      
                    </ItemTemplate>
                </asp:TemplateField> 
                <asp:BoundField HeaderText="科室描述" DataField="Description" />
        ...
        <uc1:Paging ID="Paging1" runat="server" tableName="H_Offic" showField="Id,OName,Description,ImgURL,ViewUser,InUsers,InTimes,IsUses" 
                selFiled="Id,OName,(select dbo.GetSubstring(Description,10)) as Description,ImgURL,ViewUser,(select dbo.GetInUser(InUser)) as InUsers,
