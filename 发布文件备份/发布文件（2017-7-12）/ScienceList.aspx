<%@ page language="C#" autoeventwireup="true" inherits="ScienceList, App_Web_wbiuerbv" %>
...
<body>
    ...
    <div class="contentPagetslf">
        ...
        <div class="rightt">
            ...
            <div class="segment">
                <ul>
                    <%System.Data.DataTable dt4 = this.GetSciences();%>
                    <% 
                        for (int i = 0; i < dt4.Rows.Count; i++)
                        { %>
                    <li><a href="ScienceShow.aspx?Id=<%=dt4.Rows[i]["Id"]%>" target="_blank">
                        <%=dt4.Rows[i]["STitle"]%></a><span><%=dt4.Rows[i]["InTime"]%></span></li>
                    <%}%>
                </ul>
            </div>
        </div>
