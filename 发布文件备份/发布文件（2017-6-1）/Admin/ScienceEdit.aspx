<%@ page language="C#" autoeventwireup="true" inherits="Admin_ScienceEdit, App_Web_tgvvesi-" validaterequest="false" %>
        ...
        <table class="tab">
            ...
            <tr>
                <td colspan="12" align="center">
                    <asp:Button ID="btnIn" runat="server" Text="添加" OnClientClick="return InScience()" />
