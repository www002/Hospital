<%@ page language="C#" autoeventwireup="true" inherits="Admin_HospitalUser, App_Web_tgvvesi-" %>
    ...
    <div align="center">
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" EmptyDataRowStyle-HorizontalAlign="Center"
            ...
            <Columns>
                ...
                <asp:BoundField HeaderText="登陆次数" DataField="LoginNum" />
                <asp:BoundField HeaderText="登陆时间" DataField="LastLoginTime" />
        ...
        <uc1:Paging ID="Paging1" runat="server" tableName="HospitalUser" showField="Id,UserName,Pwd,LoginNum,LastLoginTime,IsUses" 
                selFiled="Id,UserName,Pwd,LoginNum,
                            (select dbo.GetInTime(LastLoginTime)) as LastLoginTime,
