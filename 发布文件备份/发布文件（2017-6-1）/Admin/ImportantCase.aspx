<%@ page language="C#" autoeventwireup="true" inherits="Admin_ImportantCase, App_Web_tgvvesi-" %>
    ...
    <div align="center">
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" EmptyDataRowStyle-HorizontalAlign="Center"
            ...
            <Columns>
                ...
                <asp:BoundField HeaderText="标题" DataField="ITitle" />
        ...
        <uc1:Paging ID="Paging1" runat="server" tableName="ImportantCase" showField="Id,ITitle,Description,ViewUser,InUsers,InTimes,IsUses" 
                selFiled="Id,ITitle,(select dbo.GetSubstring(Description,10)) as Description,ViewUser,(select dbo.GetInUser(InUser)) as InUsers,
