<%@ page language="C#" autoeventwireup="true" inherits="Admin_ScienceField, App_Web_tgvvesi-" %>
...
<body>
    ...
    <div align="center">
        ...
        <uc1:Paging ID="Paging1" runat="server" tableName="ScienceField" showField="Id,FTitle,Description,ViewUser,InUsers,InTimes,IsUses" 
                selFiled="Id,FTitle,(select dbo.GetSubstring(Description,10)) as Description,ViewUser,(select dbo.GetInUser(InUser)) as InUsers,
