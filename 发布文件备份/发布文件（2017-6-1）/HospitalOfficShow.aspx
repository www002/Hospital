<%@ page language="C#" autoeventwireup="true" inherits="HospitalOfficShow, App_Web_wbiuerbv" %>
    ...
    <div class="contentPagetslf">
        ...
        <div class="rightt">
            <div class="rightt_top">
                ...
                <div class="zi">
                    <asp:Label ID="tit" runat="server">医院科室</asp:Label></div>
                <div class="rg">
                    <img src="img/munbtn/neir_r1_c14.jpg" /></div>
            </div>
            <div class="segmentDetail">
                <div class="title">
                    <%Models.H_Offic hf = this.GetH_OfficById();%>
                    <%if (hf != null)
                      {%>
                    <h2>
                        <%=hf.OName.ToString()%></h2>
                    <h5>
                        文章来源：本站原创 发布时间：<%=hf.InTime%>
                        文章人气数：<%=hf.ViewUser%></h5>
                </div>
                <div class="content">
                    <p>
                        <%=hf.Description%>
