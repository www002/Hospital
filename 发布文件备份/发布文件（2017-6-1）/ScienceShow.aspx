<%@ page language="C#" autoeventwireup="true" inherits="ScienceShow, App_Web_wbiuerbv" %>
    ...
    <div class="contentPagetslf">
        ...
        <div class="rightt">
            <div class="rightt_top">
                ...
                <div class="zi">
                    <asp:Label ID="tit" runat="server">科学研究</asp:Label></div>
                <div class="rg">
                    <img src="img/munbtn/neir_r1_c14.jpg" /></div>
            </div>
            <div class="segmentDetail">
                <div class="title">
                    <%Models.Science news = this.GetScienceById();%>
                    <%if (news != null)
                      {%>
                    <h2>
                        <%=news.STitle.ToString()%></h2>
                    <h5>
